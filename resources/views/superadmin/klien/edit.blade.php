...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" action="/superadmin/klien/edit/{{$data->id}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="dinas" class="form-control" value="{{$data->dinas}}" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Nama pimpinan</label>
                        <input type="text" name="pimpinan" class="form-control" value="{{$data->pimpinan}}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer">
                    ...
                    <a href="/superadmin/klien" class="btn btn-danger">Kembali</a>
                </div>
            </form>
            <!-- /.card-body -->
        </div>
